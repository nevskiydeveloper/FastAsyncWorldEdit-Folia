...
//FAWE end
    ...
    public boolean setLocation(Location location) {
        org.bukkit.entity.Entity entity = entityRef.get();
        if (entity != null) {
            return BukkitSchedulerCompat.callEntity(WorldEditPlugin.getInstance(), entity, () -> entity.teleport(BukkitAdapter.adapt(location)));
        } else {
            return false;
        }
    }
    ...
    public boolean remove() {
        ...
        return BukkitSchedulerCompat.callEntity(WorldEditPlugin.getInstance(), entityRef.get(), () -> {
            org.bukkit.entity.Entity entity = entityRef.get();
            if (entity != null) {
                try {
                    entity.remove();
