...
public class BukkitPlayer extends AbstractPlayerActor {
    ...
    private <T> T withPlayer(Supplier<T> supplier) {
        return BukkitSchedulerCompat.callEntity(plugin, player, supplier);
    }
    //FAWE end
    ...
    public boolean trySetPosition(Vector3 pos, float pitch, float yaw) {
        ...
        //FAWE end
        return withPlayer(() -> player.teleport(new Location(
                finalWorld,
                pos.x(),
                pos.y(),
                pos.z(),
    ...
    public boolean setLocation(com.sk89q.worldedit.util.Location location) {
        return withPlayer(() -> player.teleport(BukkitAdapter.adapt(location)));
    }
